# Generated by Django 2.0.8 on 2018-09-13 15:27
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('publish_date', models.DateTimeField(default=datetime.datetime(2018, 9, 13, 15, 27, 10, 24637), help_text='发布日期', verbose_name='发布日期')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('categorys', models.ForeignKey(help_text='大类', on_delete=django.db.models.deletion.CASCADE, related_name='items', to='news_article.Category')),
            ],
            options={
                'verbose_name': '新闻子栏目',
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('articles', models.ForeignKey(help_text='文章id', on_delete=django.db.models.deletion.CASCADE, related_name='articles', to='news_article.Article', verbose_name='文章')),
        ...
        migrations.AddField(
            model_name='article',
            name='item',
            field=models.ForeignKey(help_text='类别名称', on_delete=django.db.models.deletion.CASCADE, related_name='item', to='news_article.Item', verbose_name='类别名称'),
        ),
        migrations.AddField(
            model_name='article',
            name='tags',
            field=models.ManyToManyField(blank=True, help_text='标签', related_name='tags', to='news_article.Tag'),
        ),
